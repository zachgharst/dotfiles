...
hi ModeMsg ctermfg=8 cterm=NONE ctermbg=NONE
hi MoreMsg ctermfg=8 ctermbg=NONE
hi NonText ctermfg=8 ctermbg=NONE
hi vimGlobal ctermfg=8 ctermbg=NONE
...
au FileType * hi LineNr ctermfg=8 ctermbg=NONE
au FileType * hi SpecialKey ctermfg=8 ctermbg=NONE
au FileType * hi ModeMsg ctermfg=8 cterm=NONE ctermbg=NONE
au FileType * hi MoreMsg ctermfg=8 ctermbg=NONE
au FileType * hi NonText ctermfg=8 ctermbg=NONE
au FileType * hi vimGlobal ctermfg=8 ctermbg=NONE
au FileType * hi goComment ctermfg=8 ctermbg=NONE
